...
const TableList = () => {
  ...
  const handleUpdate = async (value, current_id) => {
    ...
    try {
      await updateCheckLogs(value, current_id);
      hide();
  ...
  useEffect(() => {
    queryCheckLogsDisplayOrder().then(r => {
  ...
  useEffect(() => {
    queryCheckLogsListDisplay().then(value => {
  ...
  return (
    <PageHeaderWrapper>
      <ProTable
        ...
        request={(params, sorter, filter) => queryCheckLogs({ ...params, sorter, filter })}
