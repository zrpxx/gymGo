...
const TableList = () => {
  ...
  const handleUpdate = async (value, current_id) => {
    ...
    try {
      await updateAgendas(value, current_id);
      hide();
  ...
  useEffect(() => {
    queryAgendasDisplayOrder().then(r => {
  ...
  useEffect(() => {
    queryAgendasListDisplay().then(value => {
  ...
  return (
    <PageHeaderWrapper>
      <ProTable
        ...
        request={(params, sorter, filter) => queryAgendas({ ...params, sorter, filter })}
