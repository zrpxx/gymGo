...
const TableList = () => {
  ...
  const handleUpdate = async (value, current_id) => {
    ...
    try {
      await updateBuys(value, current_id);
      hide();
  ...
  useEffect(() => {
    queryBuysListDisplay().then(value => {
  ...
  return (
    <PageHeaderWrapper>
      <ProTable
        ...
        request={(params, sorter, filter) => queryBuys({ ...params, sorter, filter })}
