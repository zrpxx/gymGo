<template>
        ...
        <template v-slot:body-cell-Action="props">
          <q-td :props="props">
            <q-btn
              ...
              flat
              @click="
                courseName = props.row.name;
                courseId = props.row.id;
                prompt = true;
              "
            />
            <q-btn
  ...
  <q-dialog v-model="prompt2" persistent maximized>
    <q-card>
      <class-chart
        align="center"
        :coach_id="coachId"
      ...
      <q-card-actions align="center" class="text-primary">
        <q-btn flat label="Cancel" v-close-popup />
        <q-btn flat label="submit" @click="fuck()" />
      </q-card-actions>
    </q-card>
  </q-dialog>
</template>
...
const columns = [
  ...
  },
  {
    name: "Coach_id",
    label: "Coach id",
    field: (row) => row.coachId,
    sortable: true,
    align: "left",
    format: (val) => `${val}`,
  },
  {
    name: "Remaining_course",
