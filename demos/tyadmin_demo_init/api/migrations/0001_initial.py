    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(1, '超级管理员'), (2, '教练'), (3, '维修员'), (4, '顾客')], default=1, verbose_name='用户类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_date_time', models.DateTimeField(default=datetime.datetime(2021, 12, 29, 15, 45, 56, 751803, tzinfo=utc), verbose_name='上课时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nick_name', models.TextField(default='神秘人', verbose_name='教练名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_zone', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.zones', verbose_name='所在区域')),
            ],
            options={
                'verbose_name': '顾客信息管理',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='api.user')),
                ('work_type', models.TextField(default='全能大师', verbose_name='工种')),
                ('salary', models.FloatField(verbose_name='工资')),
            ],
            options={
                'verbose_name': '修理员管理',
                'verbose_name_plural': '修理员管理',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.zones', verbose_name='设备位置')),
            ],
            options={
                'verbose_name': '设备管理',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('due_time', models.DateTimeField(default=datetime.datetime(2021, 12, 29, 16, 45, 56, 753803, tzinfo=utc), verbose_name='过期时间')),
        ...
        migrations.AddField(
            ...
            name='coach',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.coaches', verbose_name='教练'),
        ),
        migrations.CreateModel(
            name='CheckLogs',
            fields=[
                ...
                ('maintainer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.maintainers', verbose_name='修理员')),
            ],
            options={
                'verbose_name': '维护日志',
